...
func (x *LongGreeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LongGreeResponse) ProtoMessage() {}

func (x *LongGreeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LongGreeResponse.ProtoReflect.Descriptor instead.
func (*LongGreeResponse) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{6}
}

func (x *LongGreeResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x6c, 0x74, 0x22, 0x46, 0x0a, 0x15, 0x47, 0x72, 0x65, 0x65, 0x74, 0x4d, 0x61, 0x6e,
	0x79, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2d, 0x0a,
	0x08, 0x67, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x11, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x69,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x41,
	...
	0x67, 0x22, 0x2a, 0x0a, 0x10, 0x4c, 0x6f, 0x6e, 0x67, 0x47, 0x72, 0x65, 0x65, 0x52, 0x65, 0x73,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x45, 0x0a, 0x09, 0x4c, 0x6f, 0x6e, 0x67, 0x47,
	0x72, 0x65, 0x65, 0x74, 0x12, 0x19, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62, 0x2e, 0x4c,
	...
	0x65, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x54,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*LongGreeResponse)(nil),          // 6: greetpb.LongGreeResponse
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	6,  // 12: greetpb.GreetService.LongGreet:output_type -> greetpb.LongGreeResponse
...
type GreetService_LongGreetClient interface {
	...
	CloseAndRecv() (*LongGreeResponse, error)
	grpc.ClientStream
}
...
func (x *greetServiceLongGreetClient) CloseAndRecv() (*LongGreeResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(LongGreeResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type GreetService_LongGreetServer interface {
	SendAndClose(*LongGreeResponse) error
...
func (x *greetServiceLongGreetServer) SendAndClose(m *LongGreeResponse) error {
	return x.ServerStream.SendMsg(m)
}
